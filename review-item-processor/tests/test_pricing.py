...
class TestCountsFromUsage:
    # Bedrock はキャッシュした分を inputTokens に入れず、別の欄で返す
    ...
    # 費用の計算で落ちると、審査は終わっているのに結果を捨てることになる
